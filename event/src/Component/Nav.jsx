          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-9">
                ...
                <p>
                  <p>
                  Celebrate Independence Day 2024 with a spectacular showcase of cultural
                  performances and patriotic festivities.
                  </p>
                </p>
                ...
                <p>
                Find hassle-free directions and convenient parking options for Independence Day
                celebrations 2024.
                </p>
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="left-content">
                  ...
                  <p>
                  Chennai Trade Centre: Known for its spacious halls and modern amenities, ideal for
                  exhibitions, conferences, and large-scale events.
                  </p>
                  <p>IC Hotel: Offers elegant banquet halls and outdoor spaces with a scenic view, perfect for
                  weddings, corporate events, and parties.</p>
                  <p>ITC Grand Chola: Known for its luxurious ambiance and sophisticated event spaces, suitable
                  for upscale weddings, conferences, and gala dinners.</p>
                  <br />
                  <p>
